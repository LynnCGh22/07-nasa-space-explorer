// Find our date picker inputs, button, and gallery container on the page.
const startInput = document.getElementById('startDate');
const endInput = document.getElementById('endDate');
const getImagesButton = document.querySelector('.filters button');
const gallery = document.getElementById('gallery');

// Use NASA's demo key for beginner projects.
// If you create your own key, replace DEMO_KEY below.
const nasaApiKey = 'DEMO_KEY';

// Set default values and valid date limits for the date inputs.
